<div class="container-fluid">
	<div class="form-group">
		<?php echo form_open("/order/back", ["class" => "form-horizontal", "role" => "form"]); ?>
			<h1>発注状況</h1>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<label class="control-label col-sm-3">発注先</label>
					<div class="col-sm-6">
						<p class="form-control-static">瀧本</p>
					</div>
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<label class="control-label col-sm-3">発注日</label>
					<div class="col-sm-6">
						<p class="form-control-static">2017/07/01</p>
					</div>
				</div>
			...
			<div class="row">
				<div class="table-responsive">
					<table class="table table-hover">
			            <thead>
			              <tr>
			                <th class="col-sm-2 col-md-1">指図No</th>
			                <th class="col-sm-1">品番</th>
			                <th class="col-sm-3 col-md-2">品名（アイテム名）</th>
			            ...
			            <tbody>
			        		...
			        		<tr>
				                <td colspan="2" rowspan="2" style="vertical-align:middle;">
									<div class="btn btn-outline-info btn-block">入荷済み</div>
				                </td>
				                <td colspan="3" rowspan="2" style="vertical-align:middle;">
				                	<a href="/stock" class="btn btn-default">入庫処理</a>
								</td>
				                <td>2017/07/07入荷</td>
				                <td>200</td>
			        		</tr>
			        		...
			        		<tr>
				                <td colspan="2" rowspan="2" style="vertical-align:middle;">
									<div class="btn btn-outline-warning btn-block">未入荷</div>
				                </td>
				                <td colspan="3" rowspan="2" style="vertical-align:middle;">
				                	<a href="/stock" class="btn btn-default">入庫処理</a>
								</td>
			        		...
			        		<tr>
				                <td colspan="2" rowspan="2" style="vertical-align:middle;">
									<div class="btn btn-outline-warning btn-block">一部入荷</div>
				                </td>
				                <td colspan="3" rowspan="2" style="vertical-align:middle;">
				                	<a href="/stock" class="btn btn-default">入庫処理</a>
								</td>
			...
			<div class="form-group">
				<div class="col-sm-offset-5">
					<div class="col-sm-3">
						<button class="btn btn-default btn-block">戻る</button>
					</div>
				</div>
			</div>
        <?php echo form_close(); ?>

<div class="container-fluid">
	...
	<div class="row">
		<div class="col-sm-10 col-sm-offset-2">
			<?= form_open(site_url( (empty($material['material_id'])) ? '/master/material/insert' : '/master/material/update' ), ['class' => 'form-horizontal']) ?>
			<?= render_input_hidden_html('material_id', $material['material_id'] ?? '') ?>
				<div class="form-group">
					<label for="" class="col-sm-2 control-label">取引先名</label>
					<div class="col-sm-2">

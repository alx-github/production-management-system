				...
				<div class="table-responsive">
					<table class="table table-hover" id="table">
			            ...
			            <tbody>
							<tr id="tr_1">
				                <td>
				                	<a href="#" class="btn btn-warning pull-right" onclick="remove_row(1);">
				                ...
				                <td><input type="number" class="form-control" id="" placeholder="999"></td>
				                <td><input type="text" class="form-control estimated_shipping_date" placeholder="2017/12/31"></td>
				                <td><input type="number" class="form-control" id="" placeholder="999"></td>
				                <td><input type="number" class="form-control" id="" placeholder="999"></td>
				                <td>
				                	<select class="form-control">
			        		...
			        		<tr id="tr_2">
				                <td>
				                	<a href="#" class="btn btn-warning pull-right" onclick="remove_row(2);">
										<span class="glyphicon glyphicon-remove"></span>
									</a>
				                </td>
				                <td><input type="text" class="form-control" id="" placeholder="59999"></td>
			        		...
			        		<tr id="tr_3">
				                <td>
				                	<a href="#" class="btn btn-warning pull-right" onclick="remove_row(3);">
										<span class="glyphicon glyphicon-remove"></span>
									</a>
				                </td>
				                <td><input type="text" class="form-control" id="" placeholder="59999"></td>
			        		...
			        		<tr id="last-row">
				                <td colspan="15"></td>
				                <td>
				                	<a href="#" id="add_row" class="btn btn-info btn-block btn-sm">
